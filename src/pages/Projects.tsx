...
const Projects: React.FC = () => {
    ...
    try {
      const projectData: Project = {
        ...
        progress: editing
          ...
          : 0,
        createdAt: editing
          ? projects.find((p) => p.id === editing)?.createdAt ||
  ...
  const handleGenerateReport = async (project: Project) => {
    try {
      ...
      const pdfBlob = pdfGenerator.generateProjectReport(
        project,
        tasks,
        workers.filter(Boolean) as any[]
      );
      ...
      <div className="grid grid-cols-1 gap-6">
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="flex gap-2 items-center">
                            ...
                            <SpeechInput
                              onResult={(transcript) =>
                                handleVoiceInput("location", transcript)
                              }
                            />
                          </div>
                        </FormControl>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="flex gap-2 items-center">
                            ...
                            <SpeechInput
                              onResult={(transcript) => {
                                const numericValue = transcript.replace(
                                  /[^0-9]/g,
                                  ""
                                );
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Lista de proyectos existentes</CardDescription>
          </CardHeader>
          <CardContent>
            {projects.length === 0 ? (
